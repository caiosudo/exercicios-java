...
public class exercicio_10 {
	...
	public static void main(String[] args) {
		...
		horaIn = scan.nextInt();
		System.out.println("Informe os minuto do início do jogo");
		minIn = scan.nextInt();
		
		System.out.println("Agora informe a hora do término do jogo");
		horaFn = scan.nextInt();
		System.out.println("Agora informe minuto do término do jogo");
		minFn = scan.nextInt();
